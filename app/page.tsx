...
export default function Home() {
  return (
    <main className="w-screen min-h-screen flex justify-center items-center py-10 px-4 bg-black">
      <div className="w-full max-w-7xl grid grid-cols-10 grid-rows-auto bg-black md:grid-rows-6 divide-x divide-y border border-zinc-800 relative">
        {/* Profile Card */}
        <Card className="order-1 row-span-full md:row-span-1 col-span-full md:col-span-3 gap-3">
          <Image
            src="/profile_pic.jpg"
          ...
          <div className="tracking-tight">
            <p className="font-bold text-xl lg:text-2xl">Devansh Bhavsar</p>
            <p className="font-semibold text-sm">Full-Stack Developer</p>
          </div>
        </Card>

        {/* Projects Card */}
        <Card className="order-4 md:order-2 col-span-full md:col-span-4 md:row-span-6 flex-col justify-start items-start p-4 overflow-hidden">
          <Projects />
        </Card>

        {/* Time Card */}
        <Card className="order-3 hidden md:flex row-span-1 col-span-3">
          <Clock />
        </Card>
        ...
        {/* Computer Card */}
        <Card className="order-5 hidden md:flex row-span-4 col-span-3">
          <Computer />
        </Card>

        {/* Education Card */}
        <Card className="order-3 md:order-6 row-span-3 col-span-full md:col-span-3 flex-col justify-start items-start gap-4">
        ...
        {/* Certificates Card */}
        <Card className="order-7 row-span-1 col-span-full md:col-span-3 flex-col justify-start items-start gap-3">
        ...
        {/* Tech Stack Card */}
        <Card className="order-8 row-span-1 hidden md:flex p-0 flex-col relative">
        ...
        {/* Socials Card */}
        <Card className="order-9 row-span-1 col-span-full md:col-span-2 justify-evenly relative">
